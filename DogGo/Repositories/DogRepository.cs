        ...
        public void UpdateDog(Dog dog)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand command = conn.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@ownerId", dog.OwnerId);
                    command.Parameters.AddWithValue("@breed", dog.Breed);
                    command.Parameters.AddWithValue("@notes", dog.Notes == null ? DBNull.Value : dog.Notes);
                    command.Parameters.AddWithValue("@imageUrl", dog.ImageUrl == null ? DBNull.Value : dog.ImageUrl);
                    command.Parameters.AddWithValue("@id", dog.Id);
